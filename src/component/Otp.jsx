    ...
    return (
        <div className='h-screen w-screen flex items-center justify-center'>
            <div class="flex flex-col items-center md:max-w-[423px] w-[380px] bg-white rounded-2xl shadow-lg p-6 sm:p-10">
                ...
                <button onClick={() => navigate('/dashboard')} type="button" className="mt-8 w-full max-w-80 h-11 rounded-full text-white text-sm bg-indigo-500 hover:opacity-90 transition-opacity">
                    Verify OTP
                </button>
            </div>
        </div>
